...
function initialResult() {
    ...
    var imgArray=resultStage.getElementsByTagName("img");
    var titleArray=resultStage.getElementsByTagName("h1");
    var descriptionArray=resultStage.getElementsByTagName("p");
